 ...
 */
void
ringbuf_free(struct ringbuf_t **rb);

/*
 * Reset a ring buffer to its initial state (empty).
 */
void
ringbuf_reset(struct ringbuf_t * rb);
...
const void *
ringbuf_set_tail(struct ringbuf_t *rb, const uint8_t *tail);
 ...
 */
size_t
ringbuf_memset(struct ringbuf_t *dst, int c, size_t len);
 ...
 */
void *
ringbuf_memcpy_into(struct ringbuf_t *dst, const void *src, size_t count);
 ...
 */
ssize_t
ringbuf_read(int fd, struct ringbuf_t *rb, size_t count);
 ...
 */
void *
ringbuf_memcpy_from(void *dst, struct ringbuf_t *src, size_t count);
 ...
 */
ssize_t
ringbuf_write(int fd, struct ringbuf_t *rb, size_t count);
 ...
 */
void *
ringbuf_copy(struct ringbuf_t *dst, struct ringbuf_t *src, size_t count);
